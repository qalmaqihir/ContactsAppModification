...
public class ContactsModificationController {
    ...
    @FXML void addContactButtonPressed(ActionEvent event) {
        if (isAnyEntryEmpty()) errorMessage.setText("All filled needed!");
        else {
    ...
    public void initialize() {
        contacts.add(new Contact("Jawad", "khan", "asdf@gmail.com", "+23234000222", "234234"));
        contacts.add(new Contact("Aaasllm", "haider", "jj@yahoo.com", "0923424223", "23423"));
